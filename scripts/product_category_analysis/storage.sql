...
HAVING product_category LIKE 'storage';
...
WHERE product_category LIKE 'storage'
...
WHERE product_category LIKE 'storage' AND revenue_performance LIKE 'high' AND ctr_performance LIKE 'high' AND ad_performance LIKE 'high' AND reach_performance LIKE 'high'
