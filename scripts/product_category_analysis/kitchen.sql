...
HAVING product_category LIKE 'kitchen';
...
WHERE product_category LIKE 'kitchen' AND revenue_performance LIKE 'high' AND ctr_performance LIKE 'high' AND ad_performance LIKE 'high' AND reach_performance LIKE 'high'
